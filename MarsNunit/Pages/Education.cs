...
namespace MarsQA_Nunit.Pages
{
    public class Education:CommonDriver
    {
        ...
        public void CreateEducation(CreateEducation record)
        {
        ...
        public void UpdateEducationRecord(UpdateEducation record)
        {
            //Click on Education Tab
            educationTab = driver.FindElement(educationTabLocator);
            educationTab.Click();
        ...
        public void DeleteEducationRecord(CreateEducation record)
        {
            //Click on Education Tab
            educationTab = driver.FindElement(educationTabLocator);
            educationTab.Click();
        ...
        //Method to create an education record without degree
        public void CreateEducationWithoutDegree(CreateEducationRecordWithoutDegree record)
        {
            //Click on Education Tab
            educationTab = driver.FindElement(educationTabLocator);
            educationTab.Click();
