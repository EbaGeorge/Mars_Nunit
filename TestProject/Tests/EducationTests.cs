...
namespace MarsQA_Nunit.Tests
{
    ...
    public class EducationTests:CommonDriver
    {
        ...
        //Method to convert json data to c# object
        ...
        public void CreateEducationRecord()
        {
            try
            {
                ...
                var testData = GetTestData();
                education.CreateEducation(driver, testData.CreateEducation);
                ...
                Assert.That(educationrecord.Text == testData.CreateEducation.CountryCollege, "Education is not added");
        ...
        public void UpdateEducationRecord()
        {
            try
            {
                ...
                var testData = GetTestData();
                education.UpdateEducationRecord(driver, testData.UpdateEducation);
                ...
                IWebElement educationrecord = driver.FindElement(By.XPath("//*[@id='account-profile-section']/div/section[2]/div/div/div/div[3]/form/div[4]/div/div[2]/div/table/tbody[last()]/tr/td[1]"));
                Assert.That(educationrecord.Text == testData.UpdateEducation.UpdatedCountryCollege, "Education Record is updated");
        ...
        public void DeleteEducationRecord()
        {
            try
            {
                ...
                var testData = GetTestData();
                education.DeleteEducationRecord(driver, testData.CreateEducation);
                ...
                Assert.That(record.Text == testData.CreateEducation.ExpectedMessage, "Education is not deleted");
