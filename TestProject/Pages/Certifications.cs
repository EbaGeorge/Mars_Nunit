...
namespace MarsQA_Nunit.Pages
{
    public class Certifications
    {
        ...
        public void CreateNewCertifications(IWebDriver driver,CreateCertification record)
        {
        ...
        public void UpdateCertifications(IWebDriver driver,UpdateCertification record)
        {
        ...
        public void DeleteCertifications(IWebDriver driver,CreateCertification record)
        {
